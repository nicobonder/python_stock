...
def app():
    st.title("Stock Ranking App")

    st.subheader("Here you have a list of tickers:")
    tickers_list = "AAPL, PLTR, TSM, BYDDF, NFLX, PLTR, LULU, ONON, VCTR, CRM, NOW, SNOW, SHOP, SQ, ZM, DOCU, CRWD, DDOG, TWLO, ROKU, ZS, OKTA, TEAM, NET, MDB, TTD, U, SE, PINS, SNAP, PTON, ETSY, UBER, LYFT, ABNB, AMD, BIO, AG, CAC, MSFT, GOOGL, AMZN, META, TSLA, NVDA, BRK.B, JPM, V, UNH, JNJ, WMT, PG, MA, HD, CVX, ABBV, KO, PEP, XOM, MRK, COST, AVGO, MCD, CRM, CSCO, TMO, ADBE, ACN, PFE, AMD, NFLX, LLY, INTC, NKE, AMGN, CAT, HON, UNP, MS, T, LIN, TXN, BKNG, GS, C, BA, DE, BLK, SCHW, GE, RTX, ISRG, NOW, PYPL, SO, ELV, CB, ADP, DHR, EQIX, MO, BMY, LOW, ZTS, SPGI, ADI, CME, BSX, AMT, MU, INTU, ICE, REGN, KDP, PGR, MMC, AON, GILD, LMT, SYK, TGT, CHTR, FISV, MDLZ, MD, USB, PNC, CI, HCA, CDNS, MSCI, TFC, MCO, IDXX, ITW, ANET, NSC, WM, ECL, ROP, TRV, VRTX, CL, AZO, KMB, CMG, SRE, IQV, PSA, F, EOG, APD, D, DUK, PCAR, ODFL, TT, YUM, MET, MAR, DXCM, ED, COF, PH, FTNT, KR, DG, AIG, PAYX, ORLY, SNPS, AJG, AXP, SHW, STZ, HIG, MCK, HAL, WEC, HSY, WMB, NOC, LHX, RSG, CTAS, OKE, MSCI, NEM, CTLT, EW, TSN, HSIC, FE, EMR, XEL, FAST, SYY, BAX, NDAQ, VLO, NUE, AFL, CCI, CHD, AMP, GWW, TDG, WST, ROP, JCI, CMS, ZBH, AMCR, CF, AVB, CEG, ATO, DTE, PPL, LUV, KHC, LVS, GLW, KIM, BXP, CINF, HES, EVRG, NRG, IRM, VTR, ETR, DLR, ESS, NI, HII, PEG, FDS, BRO, MKC, SWKS, TSCO, EIX, DOV, WDC, J, UDR, HBAN, VICI, EXR, PKG, ALB, L, DHI, TRGP, XYL, AKAM, MAA, FANG, CTVA, WAT, LNT, CMS, MPWR, NDSN, AEE, RPM, TROW, CBRE, JBHT, RHI, WRB, DPZ, TTWO, ZION, BKR, MTB, POOL, KKR, PFG, RMD, VMC, HOLX, AAP, JKHY, WRK, AIZ, PKI, JAZZ, DXC, IEX, SIVB, LII, IT, JNPR, WHR, NI, HST, ROK, ETN, LNC, DRE, FRC, HBAN, VNO, IFF, MTCH, K, EXPD, VTRS, GRMN, HRL, CAG, FOXA, TPR, WY, WU, WH, PWR, UNM, NVR, KIM, LDOS, FOX, PNR, PNW, SJM, TCBI, NOV, CNP, STX, FTV, LEG, RGA, BEN, AOS, NWSA, IART, CNQ, SU, RY, TD, ENB, TRP, BNS, MFC, POW, BCE, CM, CNR, CP, T, EMA, FTS, NA, SLF, WCN, IFC, GWO, PPL, BN, WSP, CCL.B, DOO, MRU, X, WPM, AGI, NGT, BTO, CG, KL, FNV, SSRM, PAAS, AEM, PVG, IMG, DGC, K, ASR, FM, LUN, IVN, ABT, AIZ, ANSS, ARE, ATO, ATR, BALL, BAX, BDX, BIO, BKH, BMY, BURL, BWA, CAH, CBOE, CCI, CCL, CEG, CHRW, CHTR, CLX, CMI, CNC, CNMD, COO, COP, CPB, CSX, CTSH, CTXS, CVNA, DELL, DGX, DIS, DOW, DRI, EFX, EIX, EL, ENPH, EQH, ET, EXC, FCX, FFIV, FITB, FRC, GE, GL, GPN, GRMN, GWW, HBI, HIG, HOLX, HPQ, HRB, HUM, IAC, IBM, ICE, INCY, INTC, IP, IQV, IRM, JBHT, JKHY, KEYS, KMI, KRC, KR, L, LH, LHX, LLY, LMT, LPX, LRCX, LVS, MA, MAR, MAS, MCHP, MCO, MD, MHK, MLM, MRNA, MSCI, MTB, MXIM, NDAQ, NEE, NI, NLOK, NOV, NRG, NTRS, NVR, NWL, OMC, O, ORCL, ORLY, OTIS, OXY, PBCT, PCG, PGR, PKI, PKG, PM, PNR, PNW, PPL, PRU, PSA, PXD, QGEN, QRVO, RCL, REG, ROK, ROST, RPM, RSG, RY, SBNY, SBUX, SBAC, SEDG, SEE, SHW, SLB, SNA, SNPS, SO, SPGI, SRE, STZ, SWK, SYK, TAP, TD, TEL, TER, TFX, TMO, TMUS, TRMB, TRV, TSCO, TT, TYL, UDR, ULTA, UMBF, UNP, UNM, UNP, UPS, URI, UTX, VFC, VLO, VMC, VNO, VRSK, VRSN, VRTX, WAT, WBA, WDC, WEC, WELL, WEN, WFC, WHR, WLTW, WM, WMT, WRB, WY, XEL, XLNX, XYL, ZBH, ZION"
